...
mgmt_disk_size     = "10Gi"
mgmt_vm_tags = {
  "datapipeline_ingress_prometheus_hostname" = "-dp-pr"
  "datapipeline_ingress_prometheus_port"       = "9090"
  "datapipeline_ingress_grafana_hostname"      = "-dp-gr"
  "datapipeline_ingress_grafana_port"          = "3000"
  "datapipeline_ingress_nodeexporter_hostname" = "-dp-no"
  "datapipeline_ingress_nodeexporter_port"     = "9100"
  "datapipeline_ingress_webserver_hostname"    = "-dp-we"
